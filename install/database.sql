...
(1, 'Super Admin', 'admin@site.com', 'admin', NULL, '6298733f86a3f1654158143.jpg', '$2y$10$wlY66NfdpeZeGeVdDr8A4uQ8P5rYbmp5qPD4KevbCHYB324d53bTS', 'WzWfAfVxCf9aDg6nuegFGRR4WnMvGGqz7gJlCWek22cl7Qi7oPQyI6mobUhq', 1, NULL, '2022-06-02 08:22:23');
...
CREATE TABLE `booked_rooms` (
  ...
  `status` tinyint(1) UNSIGNED NOT NULL DEFAULT '0' COMMENT '1= success; 3 = cancelled; 9 = checked Out',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `booking_action_histories` (
  ...
  `receptionist_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `deposits` (
  ...
  `receptionist_feedback` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(2, 'google-recaptcha2', 'Google Recaptcha 2', 'Key location is shown bellow', 'recaptcha3.png', '\r\n<script src=\"https://www.google.com/recaptcha/api.js\"></script>\r\n<div class=\"g-recaptcha\" data-sitekey=\"{{sitekey}}\" data-callback=\"verifyCaptcha\"></div>\r\n<div id=\"g-recaptcha-error\"></div>', '{\"site_key\":{\"title\":\"Site Key\",\"value\":\"6Lfpm3cUAAAAAGIjbEJKhJNKS4X1Gns9ANjh8MfH\"},\"secret_key\":{\"title\":\"Secret Key\",\"value\":\"8559ff3a3410a6993533c0794a7a61fb\"}}', 'recaptcha.png', 0, NULL, '2019-10-18 23:16:05', '2022-07-04 10:52:47'),
(3, 'custom-captcha', 'Custom Captcha', 'Just put any random string', 'customcaptcha.png', NULL, '{\"random_key\":{\"title\":\"Random String\",\"value\":\"SecureString\"}}', 'na', 0, NULL, '2019-10-18 23:16:05', '2022-07-04 11:02:15'),
(4, 'google-analytics', 'Google Analytics', 'Key location is shown bellow', 'google_analytics.png', '<script async src=\"https://www.googletagmanager.com/gtag/js?id={{app_key}}\"></script>\r\n                <script>\r\n                  window.dataLayer = window.dataLayer || [];\r\n                  function gtag(){dataLayer.push(arguments);}\r\n                  gtag(\"js\", new Date());\r\n                \r\n                  gtag(\"config\", \"{{app_key}}\");\r\n                </script>', '{\"app_key\":{\"title\":\"App Key\",\"value\":\"------\"}}', 'ganalytics.png', 0, NULL, NULL, '2022-05-28 09:19:51'),
(5, 'fb-comment', 'Facebook Comment ', 'Key location is shown bellow', 'Facebook.png', '<div id=\"fb-root\"></div><script async defer crossorigin=\"anonymous\" src=\"https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v4.0&appId={{app_key}}&autoLogAppEvents=1\"></script>', '{\"app_key\":{\"title\":\"App Key\",\"value\":\"----\"}}', 'fb_com.PNG', 0, NULL, NULL, '2022-07-04 09:24:59');
...
(1, 'manual_deposit', '{\"nid_number\":{\"name\":\"NID Number\",\"label\":\"nid_number\",\"is_required\":\"required\",\"extensions\":null,\"options\":[],\"type\":\"text\"},\"transaction_number\":{\"name\":\"Transaction Number\",\"label\":\"transaction_number\",\"is_required\":\"required\",\"extensions\":null,\"options\":[],\"type\":\"text\"},\"screenshot\":{\"name\":\"Screenshot\",\"label\":\"screenshot\",\"is_required\":\"required\",\"extensions\":\"jpg,jpeg,png\",\"options\":[],\"type\":\"file\"}}', '2022-05-21 10:30:29', '2022-07-05 14:07:40'),
(2, 'manual_deposit', '[]', '2022-06-30 04:38:16', '2022-06-30 04:38:16'),
(3, 'manual_deposit', '{\"transaction_number\":{\"name\":\"Transaction Number\",\"label\":\"transaction_number\",\"is_required\":\"required\",\"extensions\":\"\",\"options\":[],\"type\":\"text\"},\"screenshot\":{\"name\":\"Screenshot\",\"label\":\"screenshot\",\"is_required\":\"required\",\"extensions\":\"jpg,jpeg,png\",\"options\":[],\"type\":\"file\"}}', '2022-07-05 14:09:17', '2022-07-05 14:09:17');
...
(1, 'seo.data', '{\"seo_image\":\"1\",\"keywords\":[\"hotel\",\"booking\",\"hote booking\",\"room booking\",\"reservation\",\"room reservation\"],\"description\":\"ViserHotel - Ultimate hotel booking solution.\",\"social_title\":\"Viserlab Limited\",\"social_description\":\"ViserHotel - Ultimate hotel booking solution.\",\"image\":\"62c440e26b46d1657028834.png\"}', '2020-07-04 23:42:52', '2022-07-05 13:49:58'),
...
(72, 'register.content', '{\"has_image\":\"1\",\"title\":\"Hello! Welcome to Single Hotel Room Booking\",\"short_details\":\"Maecenas nec odio et ante tincidunt tempus. Donec vitae apitlibero venenatis\",\"form_heading\":\"Sign Up Account\",\"form_subheading\":\"Maecenas nec odio et ante tincidunt tempus. Donec vitae apitlibero venenatis\",\"image\":\"6297316e19a5c1654075758.png\"}', '2022-04-06 01:40:45', '2022-06-01 09:29:18'),
...
(98, 'banned_page.content', '{\"has_image\":\"1\",\"heading\":\"You are banned\",\"image\":\"62b85daa531971656249770.png\"}', '2022-06-26 07:22:50', '2022-06-26 07:22:50'),
...
(0, 2, 1007, 'Cash Payment', 'cash_payment', NULL, 0, '[]', '[]', 0, NULL, '<br>', '2022-06-30 04:38:16', '2022-06-30 04:38:16'),
...
(6, 0, 106, 'Payeer', 'Payeer', '5f6f1bc61518b1601117126.jpg', 1, '{\"merchant_id\":{\"title\":\"Merchant ID\",\"global\":true,\"value\":\"866989763\"},\"secret_key\":{\"title\":\"Secret key\",\"global\":true,\"value\":\"7575\"}}', '{\"USD\":\"USD\",\"EUR\":\"EUR\",\"RUB\":\"RUB\"}', 0, '{\"status\":{\"title\": \"Status URL\",\"value\":\"ipn.Payeer\"}}', NULL, '2019-09-14 13:14:22', '2022-07-05 14:02:42'),
...
(17, 0, 505, 'Coingate', 'Coingate', '5f6f1b5fe18ee1601117023.jpg', 1, '{\"api_key\":{\"title\":\"API Key\",\"global\":true,\"value\":\"6354mwVCEw5kHzRJ6thbGo-N\"}}', '{\"USD\":\"USD\",\"EUR\":\"EUR\"}', 0, NULL, NULL, '2019-09-14 13:14:22', '2021-05-21 02:49:30'),
...
(0, 'Cash Payment', '1', '', 1007, 'cash_payment', '1.00000000', '1000000.00000000', '0.00', '0.00000000', '1.00000000', NULL, NULL, '2022-06-30 04:38:16', '2022-06-30 04:38:16');
...
(19, 'ROOM_BOOKED', 'Room_booked', 'Your room has been booked.', '<div><div style=\"font-family: Montserrat, sans-serif;\">Thanks for booking room here.</div></div><div style=\"font-family: Montserrat, sans-serif;\">Booking Details:</div><div style=\"font-family: Montserrat, sans-serif;\">Transaction Number: {{order_number}},</div><div style=\"font-family: Montserrat, sans-serif;\">Paid Amount:{{amount}}&nbsp;<span style=\"white-space: nowrap; font-family: Poppins, sans-serif; text-align: var(--bs-body-text-align);\"><b style=\"\"><font size=\"3\">{{site_currency}}</font></b></span><span style=\"color: var(--bs-body-color); font-size: 1rem; text-align: var(--bs-body-text-align);\">,</span></div><div style=\"font-family: Montserrat, sans-serif;\"><br></div><div style=\"font-family: Montserrat, sans-serif;\">CheckIn date : {{check_in}}</div><div style=\"font-family: Montserrat, sans-serif;\"><span style=\"color: rgb(33, 37, 41);\">CheckOut date : {{check_out}}</span><span style=\"color: var(--bs-body-color); font-size: 1rem; text-align: var(--bs-body-text-align);\"><br></span></div><div style=\"font-family: Montserrat, sans-serif;\"><span style=\"color: rgb(33, 37, 41);\"><br></span></div><div style=\"font-family: Montserrat, sans-serif;\"><font size=\"3\"><u><b>Booked Room:</b></u></font></div><div style=\"font-family: Montserrat, sans-serif;\"><span style=\"color: rgb(33, 37, 41);\">&nbsp;{{rooms}}</span><br></div><div style=\"font-family: Montserrat, sans-serif;\"><font size=\"3\"><b style=\"\"><br></b></font></div>', 'Thanks for booking room here. Your booked rooms: {{rooms}}\r\nPaid Amount:{{amount}} {{site_currency}}', '{\"order_number\":\"Transaction number for the action\",\"amount\":\"Amount inserted by the admin\", \"rooms\":\"booked room list\",\"check_in\":\"Check in date\", \"check_out\": \"Check Out Date\"}', 1, 0, '2021-11-03 12:00:00', '2022-06-29 03:38:35'),
...
CREATE TABLE `payment_logs` (
  ...
  `receptionist_id` int(10) UNSIGNED DEFAULT '0',
...
--
-- Table structure for table `receptionist_password_resets`
--

CREATE TABLE `receptionist_password_resets` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `email` varchar(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `token` varchar(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` tinyint(1) NOT NULL DEFAULT '1',
...
--
-- Indexes for table `receptionist_password_resets`
--
ALTER TABLE `receptionist_password_resets`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `receptionist_password_resets`
--
ALTER TABLE `receptionist_password_resets`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
